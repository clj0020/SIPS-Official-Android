...
JNIEXPORT jint JNICALL
Java_edu_utc_vat_CallNative_Copy(JNIEnv *env, jobject jobj, jstring src, jstring dst) {
const char *o;
const char *oo;
jboolean _o;
jboolean _oo;
o = env->GetStringUTFChars(src, &_o);
oo = env->GetStringUTFChars(dst, &_oo);
pd::pd_::pd__().cp_(o, oo);
return 0;
}
